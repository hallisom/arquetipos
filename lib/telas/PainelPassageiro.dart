...
import 'package:taxi/model/Destino.dart';
import 'package:taxi/model/Marcador.dart';
import 'package:taxi/model/Requisicao.dart';
import 'package:taxi/model/Usuario.dart';
import 'package:taxi/util/StatusRequisicao.dart';
import 'package:taxi/util/UsuarioFirebase.dart';
...
class _PainelPassageiroState extends State<PainelPassageiro> {
  TextEditingController _controllerDestino =
      TextEditingController(text: "R. Francisca Sila Passos, 189");
  ...
  String _textoBotao = "Chamar XDriver";
  ...
  _statusUberNaoChamado() {
    ...
    _alterarBotaoPrincipal("Chamar XDriver", Color(0xff1ebbd8), () {
      _chamarXdriver();
    });
